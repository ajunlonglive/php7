...
1. Installs PHP from role default package sources, enables the OpCache, cURL, GMP, XSL, MBString and XDebug extensions, 
configures the CLI SAPI and tests Composer is available
...
to bring up a local testing environment
2. `$ cd php7/tests/provisioning/site-testing-local`
3. `$ vagrant up`
4. `$ cd ..`
...
Results for these tests can be found [here](https://semaphoreci.com/bas-ansible-roles-collection/php7).
